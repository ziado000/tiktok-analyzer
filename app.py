...
<style>
    ...
    @media print {
        ...
        .css-1r6slb0, .stDataFrame, .plotly-graph-div {
            ...
            margin-bottom: 10px;
            break-inside: avoid; /* منع قص العناصر بين الصفحات */
        }
        /* تكبير الخطوط قليلاً للطباعة */
        body { font-size: 12pt; }
        
        /* إخفاء الروابط التشعبية عند الطباعة لتبدو كنص عادي */
...
if analyze_btn and raw_urls:
    ...
    if urls_list:
        ...
        if data_result:
            ...
            # --- الرسم البياني ---
            # تم إزالة عبارة "اضغط لفتح الرابط" من العنوان عشان التقرير الرسمي
            ...
            # تكوين الرابط (يشتغل في الويب، ويظهر كنص عادي في الطباعة بفضل الـ CSS)
            ...
            if color_mode == "تخصيص يدوي":
                # في التخصيص اليدوي، نستخدم الاسم العادي مؤقتاً لتسهيل التحرير
